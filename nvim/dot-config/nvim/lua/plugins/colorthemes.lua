return {
  ...
  { 'EdenEast/nightfox.nvim', enabled = false, lazy = false, priority = 1000 },
  {
    ...
    config = function()
      ...
      vim.api.nvim_set_hl(0, 'SpellBad', { fg = colors.base, bg = colors.maroon })
      vim.api.nvim_set_hl(0, 'SpellCap', { fg = colors.base, bg = colors.sky })
      vim.api.nvim_set_hl(0, 'SpellLocal', { fg = colors.base, bg = colors.sky })
    end,
  },
